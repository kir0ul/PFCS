...
image_path = "/Users/wendy/Desktop/school/uml/robotics/auto_correlation/raw data/data files/fetch_table_demos/long tasks/screenshots/wperson.png"
...
ax[1].legend(handles=legend_patches, loc="lower center", bbox_to_anchor=(0.5, -1.0), ncol=len(subtasks))
